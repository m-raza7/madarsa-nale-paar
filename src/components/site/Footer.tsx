    ...
    <footer className="mt-20 bg-sidebar text-sidebar-foreground">
      <div className="container mx-auto px-4 py-14 grid gap-10 md:grid-cols-4">
        <div>
          ...
          <p className="text-sm text-sidebar-foreground/70 font-arabic text-lg mb-2">
          ...
          <ul className="space-y-2 text-sm">
            {[
              ...
              <li key={h}>
                <Link
                  to={h}
                  className="text-sidebar-foreground/80 hover:text-gold transition-colors"
                >
                  {l}
                </Link>
              </li>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-sidebar-foreground/80">
            ...
            <li className="flex gap-2">
              ...
              <span>info@madrasaalnoor.edu</span>
            </li>
          </ul>
          <div className="flex gap-3 mt-4">
            <a
              href="#"
              aria-label="Facebook"
              className="grid h-9 w-9 place-items-center rounded-full bg-sidebar-accent hover:bg-gold hover:text-gold-foreground transition-colors"
            >
