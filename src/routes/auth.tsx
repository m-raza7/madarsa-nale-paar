...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign In — Madarsa NALE-PAAR" },
      { name: "description", content: "Login or register for the Madarsa NALE-PAAR portal." },
        ...
        <Tabs defaultValue="login" className="w-full">
          ...
          <TabsContent value="login">
            <form onSubmit={handleLogin} className="space-y-3">
              ...
              <Button type="submit" disabled={busy} className="w-full bg-primary-gradient">
                Sign In
              </Button>
            </form>
          </TabsContent>
          ...
          <TabsContent value="signup">
            <form onSubmit={handleSignup} className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground text-center">
                New accounts get <span className="text-primary font-semibold">Student</span> role by
                default. An admin can upgrade you to Teacher.
              </p>
            </form>
          </TabsContent>
        </Tabs>
